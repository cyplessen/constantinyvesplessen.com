...
# Why Multiverse Meta-Analysis? <img src="pics/logo.svg" align="right" height="139" alt="metaMultiverse hex logo" />
...
table(data$condition_arm1)

# See what types of control conditions are included
table(data$condition_arm2)
```
...
print(multiverse_specs_example_1$factors)
```
...
# How many analyses will we run?
print(paste("Total analyses:", nrow(multiverse_full_example_1$specifications)))
```
...
```{r}
# Check multiverse structure
table(multiverse_specs_example_2$results$multiverse_id)
```
